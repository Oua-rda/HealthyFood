...
function Contact() {
  return (
    <section
      className="relative py-20 bg-gradient-to-b from-green-50 via-white to-green-100"
      id="contact"
    >
      ...
      <div className="relative z-10 max-w-4xl px-6 mx-auto text-center">
        ...
        <motion.form
          ...
          className="p-8 space-y-6 bg-white border border-green-100 shadow-lg rounded-2xl"
          onSubmit={(e) => {
            e.preventDefault();
        ...
        >
          <div className="grid gap-6 md:grid-cols-2">
            <div className="text-left">
              ...
              <input
                ...
                style={{ focusRingColor: greenColor, focusShadowColor: `${greenColor}80` }}
              />
            </div>
            <div className="text-left">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            type="submit"
            className="flex items-center justify-center w-full gap-2 px-6 py-3 font-semibold text-white transition shadow-md md:w-auto rounded-xl"
            style={{ backgroundColor: '#9cc43c'}}
            onMouseEnter={e => (e.currentTarget.style.backgroundColor = '#789f52')}
            onMouseLeave={e => (e.currentTarget.style.backgroundColor = '#9cc43c')}
        ...
        <div className="flex items-center justify-center gap-2 mt-12 text-gray-600">
          <MessageSquare size={20} color={greenColor} />
